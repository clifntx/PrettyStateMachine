param(
    $repoPath= "DEFAULT", #$(throw "No config provided.  Please include the path to a config csv."),
    $pushPath = "C:\Push",
    $logLevel = -1
    )
...
$logLevel = $logLevel
$repoPath = "https://s3.amazonaws.com/aait/scripts/main.ps1"
$repoPath = "https://s3.amazonaws.com/aait/scripts/QAStandardSetup.ps1"
$path = "$pushPath\temp.ps1"
clear
