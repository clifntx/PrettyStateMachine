...
Param(
    [string]$printerCsv = $(throw ">> ERROR: Please include a path to a printer csv."),
    ...
    $DRIVER_URL_MAP = @(
        ...
        @{"driver"="Xerox Global Print Driver PCL6"; "path"="\Toshiba\64bit\eSf6u.inf"; "url" = "https://s3.amazonaws.com/aait/Xerox.zip"},
